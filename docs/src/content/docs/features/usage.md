...
Switch **Display → Mode** to **Usage metrics** to show your Claude consumption. It is a desk usage meter on the SmallTV over WiFi. The device's USB is power only, so nothing is wired between it and your PC.
