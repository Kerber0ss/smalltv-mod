...
//
// The firmware builds with full BearSSL for HTTPS APIs that require ECDHE.
// Full BearSSL by default advertises x25519 + P-256/384/521 and lets
...
// buffers and the contiguous-heap guard in the HTTP clients.
// (Under BEARSSL_SSL_BASIC there is no EC engine to pin, so this is skipped in
// the small loader build.)
